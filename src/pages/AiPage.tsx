  ...
  const renderInputArea = () => (
    <div className="shrink-0 px-3 md:px-6 pb-3 md:pb-5 pt-2">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="relative rounded-2xl border border-border/60 bg-card shadow-[0_1px_8px_-2px_hsl(0_0%_0%/0.06)] focus-within:border-foreground/15 focus-within:shadow-[0_2px_16px_-4px_hsl(0_0%_0%/0.1)] transition-all duration-200">
          {/* Textarea row */}
                      ...
                      {AI_FEATURES.map((feature) => (
                        <DropdownMenuItem
                          ...
                          onClick={() => {
                            ...
                            if (feature.prefill) setInput(feature.prefill);
                            setWebSearchEnabled(feature.label === "Web Search");
                          }}
                          className="gap-2 text-[13px]"
                        >
                          {feature.icon}
                          <span className="flex-1">{feature.label}</span>
                          {selectedFeature === feature.label && <Check className="h-3.5 w-3.5 text-primary" />}
                        </DropdownMenuItem>
                      ))}
                    </DropdownMenuSubContent>
                  </DropdownMenuSub>
